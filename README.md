...
## 簡介
為協助女友解決工作需要抓取台灣所有合法的旅宿資訊，因此找到「台灣旅宿網」此網站並爬取旅館、民宿的基本資訊，並保存到 Excel 檔案中。該程式於 2017/08/05 完成，透過 `Python 2.7`、`requests`、`beautifuloup4` 實作，後因該網站改版更新，已有提供 CSV 資料匯出所以不需要此專案，不過目前依然保持維護及更新，作為功能優化與重構的練習。
